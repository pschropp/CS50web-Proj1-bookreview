"""new tables for users, reviews and books

Revision ID: 4a164e03e124
Revises: 
Create Date: 2020-05-26 19:39:54.750751
...
def upgrade():
    ...
    sa.Column('rev_id', sa.String(length=10), nullable=False),
    sa.Column('isbn', sa.String(length=13), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('rev_rating', sa.Integer(), nullable=False),
    sa.Column('rev_text', sa.String(), nullable=False),
